...
\section{CATEGORY THEORY E ESTRUTURAS}
...
\begin{enumerate}[label={}, leftmargin = 2em, topsep = 0pt, itemsep = 1ex,partopsep = 1ex, parsep = 1ex]
	\item \textit{(Identidade)} Para todo objeto $a, b \in Ob(C)$ e todo morfismo $f: a \rightarrow b$, tem-se $f \circ id_a = f$ e $id_b \circ f = f$;
