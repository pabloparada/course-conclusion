...
\paragraph{Identidade - $leftIdentity$ e $rightIdentity$} encapsular um valor em um contexto monádico não deve apresentar alterações no valor ou na mónade.
