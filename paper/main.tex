...
\section{PARADIGMA FUNCIONAL E LAMBDA EXPRESSIONS}
\label{sec:func-para}
...
\begin{enumerate}[label=(\alph*), leftmargin=3em, topsep = 0pt, itemsep = 1ex, partopsep = 1ex, parsep = 1ex]
	...
	\item e a função de flecha (também chamada $F$) que atribui cada morfismo $f: a \rightarrow b \in C$ para um morfismo $F(f):F(a) \rightarrow F(b) \in D$.
\end{enumerate}
