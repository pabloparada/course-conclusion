...
Em sua quinta versão, tendo como base o trabalho de~\cite{bracha1998making} Java conta com tipos genéricos. “Tipos genéricos permitem abstrações sobre tipos”~\cite{bracha2004generics}. A abstração de tipos nos permite utilizar tipos parametrizáveis, generalizando implementações de interfaces, classes e métodos. Com isto, o compilador é capaz de checar os tipos em tempo de compilação, evitando erros em tempo de execução e casts excessivos.
