...
Além disso, as regras das estruturas subjacentes na flecha é mantida. O resultado da cadeia de $h \; andThen \; f \; andThen \; g$ com a chamada de $run$ parametrizada pelo inteiro de valor $5$ resulta em uma instância de $Just(10)$. De maneira semelhante, se umas destas funções retornar uma instância de $Nothing$, tal cadeia não será executada e retornará $Nothing$, mantendo o comportamento da mónade de nulidade.
