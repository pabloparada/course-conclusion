...
\centering
	\begin{tikzpicture}[baseline=-0.8ex]
    	...
    	\path[->]
			...
			(m-1-1) edge node[left = 0.3cm, below = 0.001cm] {$g \circ f$} (m-2-2);
	\end{tikzpicture}
\caption{Composição das funções $f$ e $g$}
