...
Desse modo, incrementou-se o suporte ao paradigma funcional na plataforma Java. Estruturas singulares podem unificar-se por uma única interface. A composição destas tornou-se polimórfica, expressada pela instância $Kleisli$ e generalizada por $Monad$. Este mesmo polimorfismo também é oferecido para desenvolvedores que desejam criar bibliotecas, onde torna-se necessário referenciar apenas interfaces padronizadas.
