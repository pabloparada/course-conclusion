...
Com a rápida adoção de mónades para a solução de problemas envolvendo E/S, percebeu-se que outros conceitos da TC também poderiam ser aproveitados. Estes foram incorporados e constituem a hierarquia de type classes.
...
A Figura~\ref{fig:typeclassopedia} conforme a Typeclassopedia~\cite{web2015typeclassopedia} demonstra as relações entre as type classes, identificadas por flechas tracejadas e pontilhadas:
