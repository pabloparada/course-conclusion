...
\begin{lstlisting}[caption={Type class para funtores\protect\footref{fnt:type-class-funtor}}, style=haskell-style, label={lst:type-class-functor}]
...
\footnote{Fonte: M. Lipovaca,~\textit{Learn You a Haskell for Great Good!: A Beginner's Guide}, 2011.\label{fnt:type-class-funtor}}
...
\begin{lstlisting}[caption={Função fmap para Maybe\protect\footref{fnt:type-class-funtor}}, style=haskell-style, label={lst:fmap-maybe}]
fmap (*2) (Just 200)  
\end{lstlisting}
